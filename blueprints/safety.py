...
# 向后兼容：函数已迁移到 services/domain/safety_utils.py
# 保留 re-export 确保现有 import 不受影响
from services.domain.safety_utils import extract_score_from_assessment  # noqa: F401
